#ifndef MOD_HEIMDALL_SCHEMA_DDL_H
#define MOD_HEIMDALL_SCHEMA_DDL_H
...
{
constexpr std::string_view SCHEMA_DDL = R"heimdall(-- mod-heimdall owns only tables with this prefix. It reads gm_ticket but never mutates it.
--
