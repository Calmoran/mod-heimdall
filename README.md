...
![Platform](https://img.shields.io/badge/tested%20on-Windows%20%7C%20Linux-blue)

> [!IMPORTANT]
> **Pre-release (v0.9.1).** Tested end to end on Windows and Linux. Docker is not tested yet.
